...
```python file=./snippets/time_travel_read.py start=start:time-travel-read end=end:time-travel-read
```
...
- [Read a Delta table](../read-a-delta-table/index.md) — the basics.
